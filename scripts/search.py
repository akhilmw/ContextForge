"""Command-line entry point for searching an ingested project index."""
...
def main():
    """Parse CLI arguments, run retrieval, and print ranked source chunks."""
    parser = argparse.ArgumentParser(
        description="Search an ingested ContextForge project index."
    )
