...
SCRIPT_PATH = PROJECT_ROOT / "scripts" / "ask_langchain.py"
...
def test_ask_langchain_script_prints_answer_and_sources(tmp_path):
    ingest_repository(
...
def test_ask_langchain_script_rejects_unknown_embedder(tmp_path):
    result = run_script(
        "--project",
        "demo",
        "--data-dir",
...
def test_ask_langchain_script_rejects_unknown_llm(tmp_path):
    result = run_script(
        "--project",
        "demo",
        "--data-dir",
...
def test_ask_langchain_script_requires_question(tmp_path):
    result = run_script(
        "--project",
        "demo",
        "--data-dir",
